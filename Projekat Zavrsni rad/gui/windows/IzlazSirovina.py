...
class IzlazSirovina(tk.Frame):
    ...
    def __init__(self,master:tk.Tk):
        ...
        self.naziv=tk.Label(self, text="IZLAZ SIROVINA",font=cst.MAIN_FONT)
        ...
        self.l_ka.grid(row=1,column=4)
        self.e_ka.grid(row=1,column=5)
    ...
    def save_event(self):
        ...
        mdl.Sirovine.brsianje_kolicine(sifra,kolicina)
        self.forget
